...
namespace AzraTasks.Data.Migrations
{
    ...
    [Migration("20260607232902_MakeModifiedDateRequired")]
    partial class MakeModifiedDateRequired
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AzraTasks.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AzraTasks.Data.TodoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AzraTasks.Data.TodoList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AzraTasks.Data.TodoItem", b =>
                {
                    b.HasOne("AzraTasks.Data.TodoList", "List")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("AzraTasks.Data.TodoList", b =>
                {
                    b.HasOne("AzraTasks.Data.ApplicationUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AzraTasks.Data.ApplicationUser", null)
                        .WithMany()
