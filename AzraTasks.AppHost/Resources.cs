...
public static class Resources
{
    ...
    public const string SqlServer = "AzraTasks-sql";
    ...
    extension(IDistributedApplicationBuilder builder)
    {
        ...
        {
            return builder.AddAzureSqlServer("AzraTasks-sql");
        }
        ...
        public IResourceBuilder<SqlServerServerResource> AddSqlServer()
        {
            ...
            string? containerName = string.IsNullOrWhiteSpace(containerSuffix) ? "AzraTasks-sql" : $"AzraTasks-{containerSuffix}-sql";
            
            return builder
                .AddSqlServer(SqlServer)
                .WithLifetime(ContainerLifetime.Persistent)
                .WithContainerName(containerName)
                .WithDataVolume("AzraTasks-database")
